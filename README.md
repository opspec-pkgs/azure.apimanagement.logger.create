[![build](https://github.com/opspec-pkgs/azure.apimanagement.logger.create/actions/workflows/build.yml/badge.svg)](https://github.com/opspec-pkgs/azure.apimanagement.logger.create/actions/workflows/build.yml)
